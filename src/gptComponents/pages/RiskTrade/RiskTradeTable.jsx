          ...
          {Array.isArray(riskTrades) && riskTrades.length > 0 ? (
            riskTrades.map((trade, index) => (
              <tr key={trade.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td className="px-6 py-4 text-black">${trade.risk_dollars}</td>
                <td className="px-6 py-4 text-black">Tsh {Math.round(trade.risk_tsh).toLocaleString()}</td>
                <td className="px-6 py-4 text-black">{trade.gain_pips}</td>
                <td className="px-6 py-4 text-black">$ {Math.round(trade.gain_dollars)}</td>
                <td className="px-6 py-4 text-black">Tsh {Math.round(trade.gain_tsh).toLocaleString()}</td>
